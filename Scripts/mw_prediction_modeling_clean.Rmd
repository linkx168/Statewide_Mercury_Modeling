...
# lake covarites 
-lets look if there are trends for lakes above and below 0.22ppm
-group by variable where lakes are above and below 0.22ppm
    -look at covaraites based on that split
```{r}
