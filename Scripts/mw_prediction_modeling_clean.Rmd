...
lake_spec_sum <- read_csv(file.path("D:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Predictive Modeling", "Random Model Final Output", "lake_spec_hg_at_harvest.csv"))
###################making map#############################
