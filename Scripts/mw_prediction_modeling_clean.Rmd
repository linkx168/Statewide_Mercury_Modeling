...
lake_spec_sum %>% 
  group_by(species) %>% 
  summarise(n_above_50 = sum(prob_over > 0.5),
            n = n(),
            prop_above_50 = n_above_50/n)
