...
```{r}
glifwc_merge <- glifwc %>% 
  #for the sake of ease I'm going to assume all mn and WI samples are duplicates and throw them out
...
#take only the most recent year and remove some unnessary variables 
...
4. all michigan are misses because we don't currently have a state level id from glifwc
