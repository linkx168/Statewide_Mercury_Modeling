...
#this shows that there are 447 cases where one spec was removed from a lake at least one species remains
...
species_changes_remain <- species_changes_remain %>%
  ...
  mutate(pred_fish_removed_no_remain = case_when(removed_species %in% c("WAE", "NOP") ~ "y"))
