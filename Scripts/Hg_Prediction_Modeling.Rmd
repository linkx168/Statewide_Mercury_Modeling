...
fit.gp <- brm(log_hg ~ 
                ...
                gp(easting, northing, gr = T, scale = F),
                     ...
                     family = gaussian(),
                     cores = 12)
#saveRDS("statewide_gp_loo_RecentYear.rds")
...
loo %>% 
  ggplot() +
  geom_point(aes(.predicted, HGPPM)) +
  geom_abline(slope = 1, intercept = 0, color = "red", linetype = "dashed") +
  theme_minimal()

#make plot that has the predictive distribtuions of each point compared to the actual value
```
