...
3. prediction model using brms and gussian processes 
...
1. filter MN state hg data relivent to prediction modeling
...
threshold <- predictions %>% 
  ...
  #this step sums each spec-length across draws so that we get a variablity in the prob like for the state
