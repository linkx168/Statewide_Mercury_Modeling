...
dow_effect %>% 
  ...
  summarise(n = n_distinct(DOW))
#the 4 lakes without nhdids are very small lakes - can manually add in later
...
nop.lake.effect <- ggplot() +
  ...
  theme(panel.background = element_rect(fill = "white"))
nop.lake.effect
ggsave("metro_nop_dow_effect.png", height = 11, width = 7, dpi = 600)
...
wae.lake.effect <- ggplot() +
  ...
  theme(panel.background = element_rect(fill = "white"))
wae.lake.effect
ggsave("metro_wae_dow_effect.png", height = 11, width = 7, dpi = 600)
```
