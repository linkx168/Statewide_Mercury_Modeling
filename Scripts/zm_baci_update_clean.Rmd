...
```{r}
combined_data <- read_csv(file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "combined_hg_data.csv"))
...
species_images <- data.frame(
  species = c("Walleye", 
              ...
              "Yellow Perch", 
              "Bluegill"),
  img = c(file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "walleye_outline.jpg"), 
          file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "pike_outline.jpg"), 
          file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "largemouth_bass_outline.jpg"), 
          file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "crappie_outline.jpg"),
          file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "perch_outline.jpg"),
          file.path("E:", "Shared drives", "Hansen Lab", "RESEARCH PROJECTS", "Statewide mercury modeling", "Zebra Mussel Baci Analysis", "Data", "bluegill_outline.jpg"))
)
...
combined_plot
ggsave("almost.jpg", height = 5, width = 9)
```
...
discount <- marg_draw_plot %>% 
  ...
  mutate(species = case_when(species == "wae" ~ "Walleye",
                             species == "nop" ~ "Northern Pike",
                             species == "lmb" ~ "Largemouth Bass",
                             species == "blc" ~ "Black Crappie",
                             species == "yep" ~ "Yellow Perch",
...
#meals per week
discount %>% 
  mutate(species = case_when(species == "bluegill" ~ "Bluegill",
                             TRUE ~ species)) %>% 
  ggplot(aes(interaction, safe_consumption_week, color = interaction)) +
  stat_pointinterval(.width = c(.66, .95)) +
  theme_minimal() +
