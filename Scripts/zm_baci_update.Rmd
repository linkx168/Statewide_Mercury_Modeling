...
lag_1 <- create_species_data(species = "WAE", data = hg.model, lag_variable = "zm_sample_lag_1")
...
1. example of running one model at a time - must change the invasion varibles and data input
```{r}
#walleye model fit
...
########################all analysis below is based off sigular model run#######
